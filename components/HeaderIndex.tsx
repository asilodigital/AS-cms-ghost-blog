        ...
        <div className="inner">
          ...
          <div className="site-header-content">
            ...
            <div className="site-header-buttons-container">
              <a onClick={() => alert("hello")} type="button" className="border border-solid border-gray-100 rounded-[37px] text-gray-100 decoration-white hover:no-underline font-semibold px-8 py-3">
